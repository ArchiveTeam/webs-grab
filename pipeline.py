...
LUA_SHA1 = get_hash(os.path.join(CWD, 'webs.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'site':
                wget_args.extend(['--warc-header', 'webs-site-id: '+item_value])
                wget_args.append('http://profiles.members.webs.com/Profile/index.jsp?userID='+item_value)
            else:
...
project = Project(
    title = 'webs',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://wiki.archiveteam.org/images/thumb/7/74/Webs-logo-white-background.png/320px-Webs-logo-white-background.png" height="50px"/>
    <h2>webs.com <span class="links"><a href="https://webs.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/webs/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://{}/{}/multi={}/'
        ...
        downloader, VERSION),
    PrepareDirectories(warc_prefix='webs'),
    WgetDownload(
        WgetArgs(),
        max_tries=1,
